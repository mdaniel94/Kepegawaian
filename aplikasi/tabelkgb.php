                  ...
                  <div class="x_content">
                      ...
                      <div role="tabpanel" class="tab-pane fade active in" id="semua" aria-labelledby="home-tab">
                       ...
                       <?php 
						...
						$no= 1;
						$hasil=mysql_query("SELECT * FROM `tb_kgb` ORDER BY `NO` ASC,`PANGKAT_GOLONGAN` DESC");
						...
						echo "
							...
							<td>$baris[TMT_JABATAN]</td>
							<td>$baris[TMT_PANGKAT]</td>
							<td>$baris[TMT_KGB]</td>
							<td>$baris[NAIK_KGB]</td>
							<td>$baris[TUGAS]</td>
							" ?>
                            <td><a href=update_kgb.php?NIP=<?php echo $baris['NIP']?>            
                <li>
                  ...
                  <span class="glyphicon-class">Setting</span>
                                    ...
                                    <br>
                            <a href=hapus_kgb.php?NIP=<?php echo $baris['NIP']?> onClick="return confirm('Apakah Anda Yakin Hapus data?')"           
                <li>
...
<?php $no++; } ?>
                       ...
                       <?php 
						include "../include/konek.php"; //sambungkan ke database
						$no= 1;
						$hasil=mysql_query("SELECT * FROM `tb_kgb` WHERE `TUGAS`='KANWIL DJBC SUMBAGSEL' ORDER BY `NO` ASC,`PANGKAT_GOLONGAN` DESC");
						while ($baris = mysql_fetch_array($hasil)){
						echo "
...
<?php $no++; } ?>
                       ...
                       <?php 
						include "../include/konek.php"; //sambungkan ke database
						$no= 1;
						$hasil=mysql_query("SELECT * FROM `tb_kgb` WHERE `TUGAS`='KPPBC TMP B PALEMBANG' ORDER BY `NO` ASC,`PANGKAT_GOLONGAN` DESC");
						while ($baris = mysql_fetch_array($hasil)){
						echo "
...
<?php $no++; } ?>
                       ...
                       <?php 
						include "../include/konek.php"; //sambungkan ke database
						$no= 1;
						$hasil=mysql_query("SELECT * FROM `tb_kgb` WHERE `TUGAS`='KPPBC TMP B BANDAR LAMPUNG' ORDER BY `NO` ASC,`PANGKAT_GOLONGAN` DESC");
						while ($baris = mysql_fetch_array($hasil)){
						echo "
...
<?php $no++; } ?>
                       ...
                       <?php 
						include "../include/konek.php"; //sambungkan ke database
						$no= 1;
						$hasil=mysql_query("SELECT * FROM `tb_kgb` WHERE `TUGAS`='KPPBC TMP B JAMBI' ORDER BY `NO` ASC,`PANGKAT_GOLONGAN` DESC");
						while ($baris = mysql_fetch_array($hasil)){
						echo "
...
<?php $no++; } ?>
                       ...
                       <?php 
						include "../include/konek.php"; //sambungkan ke database
						$no= 1;
						$hasil=mysql_query("SELECT * FROM `tb_kgb` WHERE `TUGAS`='KPPBC TMP B BENGKULU' ORDER BY `NO` ASC,`PANGKAT_GOLONGAN` DESC");
						while ($baris = mysql_fetch_array($hasil)){
						echo "
...
<?php $no++; } ?>
                       ...
                       <?php 
						include "../include/konek.php"; //sambungkan ke database
						$no= 1;
						$hasil=mysql_query("SELECT * FROM `tb_kgb` WHERE `TUGAS`='KPPBC TMP B PANGKAL PINANG' ORDER BY `NO` ASC,`PANGKAT_GOLONGAN` DESC");
						while ($baris = mysql_fetch_array($hasil)){
						echo "
...
<?php $no++; } ?>
                       ...
                       <?php 
						include "../include/konek.php"; //sambungkan ke database
						$no= 1;
						$hasil=mysql_query("SELECT * FROM `tb_kgb` WHERE `TUGAS`='KPPBC TIPE PRATAMA TANJUNG PANDAN' ORDER BY `NO` ASC,`PANGKAT_GOLONGAN` DESC");
						while ($baris = mysql_fetch_array($hasil)){
						echo "
