        ...
        <div class="right_col" role="main">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Tabel Setting Data Pensiun</h2>
                  ...
                  <div class="x_content">
                      <table class="table table-striped table-bordered" id="datatable" >
                       ...
                       <?php 
						...
						$no= 1;
						$hasil=mysql_query("select * FROM tb_pensiun order by TAHUN_PENSIUN ASC");
						...
						echo "
							...
							<td>$baris[TUGAS]</td>
							" ?>
                            <td><a href=update_pensiun.php?NIP=<?php echo $baris['NIP']?>            
                <li>
                  ...
                  <span class="glyphicon-class">Setting</span>
                                    ...
                                    <br>
                            <a href=hapus_pensiun.php?NIP=<?php echo $baris['NIP']?> onClick="return confirm('Apakah Anda Yakin Hapus data?')"           
                <li>
