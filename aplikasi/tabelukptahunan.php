...
if(isset($_SESSION['username'])){
	...
	$hasil = mysql_query("SELECT * FROM tb_ukp WHERE");
...
<html lang="en">
  ...
  <body class="nav-md">
	...
	while(list($NAMA_PEGAWAI,$NIP,$PANGKAT_GOLONGAN,$TMT_CPNS,$JABATAN_ESELON,$TMT_PANGKAT,$NAIK_PANGKAT,$TUGAS)=mysql_fetch_array($query)):
	$no++;
	?>
