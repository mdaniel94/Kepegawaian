...
$hasil = mysql_query("SELECT * FROM tb_pensiun WHERE NIP = $NIP");
                ...
                <div class="x_panel">
                  ...
                  <div align="center">
                     <table width="100%" height="700" border="0">
                      <form id="form1" name="postform" method="post" action="perbaruipensiun.php">
		                      <tr>
		                        <td width="143">No</td>
		                        <td width="8">:</td>
		                        <td width="456">
                                <input name="no" type="text" class="form-control" id="no" value="<?php echo $baris['NO']?>"/>
                                </td>
	                          </tr>
		                      <tr>
		                        <td>Nama Pegawai</td>
							...
							<div class='input-group date' id='datepicker1'>
		                          <input name="tahun_pensiun" value="<?php echo $baris['TAHUN_PENSIUN']?>" type" required class="form-control col-md-7 col-xs-12" id="sk_pangkat""text>
                                  <span class="input-group-addon">
									<span class="glyphicon glyphicon-calendar"></span>
								</span>
							</div>
