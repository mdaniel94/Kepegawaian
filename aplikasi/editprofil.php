        ...
        <div class="right_col" role="main">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Tabel Pengolahan Data Pegawai</h2>
                  ...
                  <div class="x_content">
                      ...
                      <li role="presentation" class="active"><a href="#semua" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Seluruh Data Pegawai SUMBAGSEL</a>
                        <li role="presentation"><a href="#tab_content1" id="profile-tab" role="tab" data-toggle="tab" aria-expanded="true">Kanwil Sumbagsel</a>
                        </li>
                        <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Palembang</a>
                        </li>
                        <li role="presentation" class=""><a href="#tab_content3" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="false">Bandar Lampung</a>
                        </li>
                        <li role="presentation" class=""><a href="#tab_content4" id="profile-tab3" role="tab" data-toggle="tab" aria-expanded="true">Jambi</a>
                        </li>
                        <li role="presentation" class=""><a href="#tab_content5" role="tab" id="profile-tab4" data-toggle="tab" aria-expanded="false">Bengkulu</a>
                        </li>
                        <li role="presentation" class=""><a href="#tab_content6" role="tab" id="profile-tab5" data-toggle="tab" aria-expanded="false">Pangkal Pinang</a>
                        </li>
                        <li role="presentation" class=""><a href="#tab_content7" role="tab" id="profile-tab6" data-toggle="tab" aria-expanded="false">Tanjung Pandan</a>
                        </li>
                      </ul>
...
<?php $no++; } ?>
                       ...
                       <?php 
						...
						$hasil=mysql_query("SELECT * FROM `tb_pegawai` WHERE `TUGAS`='KANWIL SUMBAGSEL' ORDER BY `NO` ASC,`PANGKAT_GOLONGAN` DESC");
						while ($baris = mysql_fetch_array($hasil)){
						...
						echo "
							...
							" ?>
                            <td><a href=updatepegawai.php?NIP=<?php echo $baris['NIP']?>            
                <li>
                  ...
                  <span class="glyphicon-class">Setting</span>
                                    ...
                                    <br>
                            <a href=hapus_pegawai.php?NIP=<?php echo $baris['NIP']?> onClick="return confirm('Apakah Anda Yakin Hapus data?')"            
                <li>
...
<?php $no++; } ?>
                       ...
                       <?php 
						...
						$hasil=mysql_query("SELECT * FROM `tb_pegawai` WHERE `TUGAS`='PALEMBANG' ORDER BY `NO` ASC,`PANGKAT_GOLONGAN` DESC");
						while ($baris = mysql_fetch_array($hasil)){
...
<?php $no++; } ?>
                       ...
                       <?php 
						...
						$hasil=mysql_query("SELECT * FROM `tb_pegawai` WHERE `TUGAS`='BANDAR LAMPUNG' ORDER BY `NO` ASC,`PANGKAT_GOLONGAN` DESC");
						while ($baris = mysql_fetch_array($hasil)){
...
<?php $no++; } ?>
                       ...
                       <?php 
						...
						$hasil=mysql_query("SELECT * FROM `tb_pegawai` WHERE `TUGAS`='JAMBI' ORDER BY `NO` ASC,`PANGKAT_GOLONGAN` DESC");
						while ($baris = mysql_fetch_array($hasil)){
...
<?php $no++; } ?>
                       ...
                       <?php 
						...
						$hasil=mysql_query("SELECT * FROM `tb_pegawai` WHERE `TUGAS`='BENGKULU' ORDER BY `NO` ASC,`PANGKAT_GOLONGAN` DESC");
						while ($baris = mysql_fetch_array($hasil)){
...
<?php $no++; } ?>
                       ...
                       <?php 
						...
						$hasil=mysql_query("SELECT * FROM `tb_pegawai` WHERE `TUGAS`='PANGKAL PINANG' ORDER BY `NO` ASC,`PANGKAT_GOLONGAN` DESC");
						while ($baris = mysql_fetch_array($hasil)){
...
<?php $no++; } ?>
                       ...
                       <?php 
						...
						$hasil=mysql_query("SELECT * FROM `tb_pegawai` WHERE `TUGAS`='TANJUNG PANDAN' ORDER BY `NO` ASC,`PANGKAT_GOLONGAN` DESC");
						while ($baris = mysql_fetch_array($hasil)){
