            ...
            <div class="row">
               <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <li>
                  ...
                  <span class="glyphicon-class">Rincian</span>
                </li>
                            		</a></td>
                            <td><a href=update_pelanggan.php?id_pelanggan=<?php echo $baris['id_pelanggan']?>            
                <li>
                  ...
                  <span class="glyphicon-class">Setting</span>
							...
							<td><a href=hapus_pelanggan.php?id_pelanggan=<?php echo $baris['id_pelanggan']?> onClick="return confirm('Apakah Anda Yakin Hapus data?')">
                <li>
