...
$hasil3 = mysql_query("SELECT * FROM tb_pegawai WHERE NIP = $NIP");
...
$baris2 = mysql_fetch_array($hasil3); //array dari tabel pasien
...
<html lang="en">
  <head>
    ...
    <title>Data UKP | Konfirmasi UKP</title>
        ...
        <div class="right_col" role="main">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Konfirmasi Kenaikan Pangkat</h2>
                  ...
                  <div align="center">
                     <table width="621" height="500" border="0">
                      <form id="form1" name="postform" method="post" action="konfirmasi_ukp.php">
		           <input name="tmt_pangkat" type='hidden' class="form-control" value="<?php echo $baris['NAIK_PANGKAT']?>" />      
		           <input name="NIP" type="hidden" class="form-control col-md-7 col-xs-12" value="<?php echo $baris['NIP']?>">
                   <input name="naik_pangkat" type='hidden' class="form-control" value="<?php echo $baris['NAIK_PANGKAT']?>" />
                              <tr>
		                        <td>Nama Pegawai</td>
		                        <td>:</td>
                            ...
                            <tr>
		                        ...
		                        <td>:</td>
		                        <td>
		                          <input id="middle-name" value="<?php echo $baris2['SK_PANGKAT']?>" class="form-control col-md-7 col-xs-12" type="text" name="sk_pangkat">
	                          </tr>
							...
							<div class='input-group date' id='tanggal_sk_pangkat'>
								<input type="text" name="tanggal_sk_pangkat" value="<?php echo $baris2['TANGGAL_SK_PANGKAT']?>" class="form-control" />
                          ...
                          <button type="submit" onClick="return confirm('Apakah Berkas Persyaratan Kenaikan Pangkat Sudah Terpenuhi?')" class="btn btn-success">Submit</button>
		                        </div></td>
		                        </tr>
