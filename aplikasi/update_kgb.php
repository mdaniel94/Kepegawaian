...
<html lang="en">
  <head>
    ...
    <title>DATA KGB | Perbarui Data</title>
                ...
                <div class="x_panel">
                  ...
                  <div align="center">
                     <table width="100%" height="700" border="0">
                      <form id="form1" name="postform" method="post" action="perbaruikgb.php">
                      <input name="nip" type="hidden" value="<?php echo $baris['NIP']?>" />   
                              ...
                              echo "<option>$jab[nama_jabatan]</option>";
                              }
                              ?>
                            </select>
	                          </tr>
							...
							<div class='input-group date' id='tmt_kgb'>
		                     ...
		                     <tr>
		                        ...
		                        <td>
		                          <div class="form-group">
							<div class='input-group date' id='naik_kgb'>
								<input type="text" value="<?php echo $baris['NAIK_KGB']?>" name="naik_kgb" class="form-control" />
								<span class="input-group-addon">
									<span class="glyphicon glyphicon-calendar"></span>
								</span>
							</div>
